...
def calculate_scores(sport_key: str = None) -> list[PlayerScore]:
    ...
    for player in players:
        ...
        if None in (w_open, t5_open, t10_open, w_cur, t5_cur, t10_cur):
            continue

        w_move   = w_cur  - w_open
        t5_move  = t5_cur - t5_open
        t10_move = t10_cur - t10_open

        qualifies = w_move > 0 and t5_move > 0 and t10_move > 0
        score     = (w_move * WEIGHT_WINNER) + (t5_move * WEIGHT_TOP5) + (t10_move * WEIGHT_TOP10)
